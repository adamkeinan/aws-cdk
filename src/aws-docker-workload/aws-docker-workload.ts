...
/**
 * Configuration options for building the aws-docker container image.
 */
export interface WordpressImageOptions {
  ...
  /**
   * Provide a aws-docker version to download. The default is to download
   * the latest aws-docker version. If you specify `awsdockerSourcePath`,
  ...
  /**
   * Provide your own aws-docker sources. When you specify this option,
...
export interface WordpressWorkloadOptions {
  ...
  /**
   * Options building the aws-docker container.
   */
  readonly awsdockerImageOptions?: aws-dockerImageOptions;

  /**
   * Name of the database containing the aws-docker site.
   */
  readonly awsdockerDatabaseName?: string;
 ...
 * @internal
 */
export class awsdockerWorkload implements IEcsWorkload {
